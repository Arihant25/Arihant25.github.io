...
<div class="flex min-h-screen items-center justify-center">
	...
	>
		...
		<p class="mb-6 text-2xl text-gray-600 dark:text-gray-400">Page Not Found</p>
		<a
			href="/"
			class="bg-orange rounded-md px-6 py-2 text-white shadow transition-colors hover:bg-blue-700"
			>Go Home</a
		>
	</div>
</div>
