...
I still live with Max’s parents now. They take good care of me, just like before. I am the only thing stopping them from falling to the depths of depression and misery. I am their only hope now.`
        },
        {
            coverImage: 'https://miro.medium.com/v2/resize:fit:1400/0*34gM4z8Y40JhcoCr.jpg',
            title: 'A Morning At The Balcony',
            description: 'Reflections from a balcony during a quiet morning in the city.',
            date: '20 June 2020',
            slug: 'a-morning-at-the-balcony',
            content: `As I sit on my tiny island of concrete and look at the world below, I can’t help but wonder at the magnificence of it all. Very few people are out on the streets at this early morning hour. And besides, ever since the virus outbreak started, the number of people outside has gone considerably lower. Are we humans the ones who are controlling the world, or is it merely an illusion we have created to satisfy our restless minds?
...
As minutes turn into hours, the sun rises from behind its usual hiding spot. Light falls on rooftops everywhere. The trees on the ground seem happier than usual to get the light. From my balcony on the eleventh floor, I look at the tiny cars zooming on the road and think about all the people in them. I wonder about their lives, where they could be heading this early in the morning, and why. From this high up, it’s easy to see why some people think we are just pawns in the grand scheme of the cosmos. I wish I could stay here for the whole day, but as more and more people appear on the roads, I realise it’s time for me to get back to my life too.`
        },
        {
            coverImage: 'https://static.vecteezy.com/system/resources/previews/011/143/527/large_2x/set-of-pets-animals-free-vector.jpg',
            title: 'On Pet Choices',
            description: "A look at people's pet preferences and the factors influencing them.",
            date: '1 October 2020',
            slug: 'on-pet-choices',
            content: `![A pie chart of people’s pet preferences](https://miro.medium.com/v2/resize:fit:996/1*6bF5S9hteL4zVg8qfLlJ4w.png)
...
The above pie chart shows the preferences of people for various pets. Pets provide enjoyment and companionship for everyone in the family, and also teach children the value of responsibility. There are numerous factors which influence the choice of an animal. Money is one such factor. Different animals have different needs and require varying amounts of money to keep. For example, fish are cheaper than dogs and cats. Hence, 16% of people own a fish or bird as a pet. Time is another factor. Some pets, like dogs, need to spend a lot of time with their owners to be happy. Nowadays, it can be difficult to fit in time in our busy lives to care and look after a pet. Therefore, 33% of people don’t own any pets, while 26% keep a dog, and only 15% have a cat. Probably the most important factor while choosing a pet in cities is space. There is a huge lack of space in apartments to keep bigger animals. That may be the reason why only 10% of people are able to keep both a dog and a cat in their home.`
        ...
        {
            coverImage: 'https://miro.medium.com/v2/resize:fit:2000/format:webp/1*sxdQ0xWn3lGX18jjPcfhiQ.jpeg',
            title: 'How I Got into IIIT Hyderabad with AIR 1',
            description: 'My journey through entrance exams, Boards, and UGEE to IIIT Hyderabad.',
            date: '19 July 2023',
            slug: 'how-i-got-into-iiit-hyderabad-with-air-1',
            content: `Entrance exams are hard. I learnt it the hard way. See, no one told me that there would be such a big *gap* between the difficulty level of class 10 and class 11.
