...
export const projects: Project[] = [
	...
	},
	{
		...
		coverImage: '/projects/quoty/quoty-1.png',
		screenshots: [
			'/projects/quoty/quoty-2.png',
			'/projects/quoty/quoty-3.png'
		],
		description:
	...
	},
	{
		...
		coverImage: '/projects/isitopen/isitopen-1.png',
		screenshots: [
			'/projects/isitopen/isitopen-2.png',
			'/projects/isitopen/isitopen-3.png',
		],
		description:
			'Is It Open? is a web application that helps users find out whether a particular establishment (like a canteen or store) is currently open or closed. The shop owners are given a pin that they can use to login to the app and set their own status. They can also enter any text for giving extra information, which automatically disappears after 12 hours. Going around to all the owners and explaining them the usage of the app was a learning experience in itself. The project also did not have a rate limit on the number of login allowed initially, which led to some people bruteforcing their way in. This was fixed later by adding ingenious rate limit logic, considering that the entire codebase is open source. This project was made in collaboration with Tanish Taneja, who approached me with the idea to create this.',
		shortDescription: 'Check if a business is currently open or closed in IIITH',
		year: 2025,
		technologies: ['Next.js', 'MongoDB'],
		slug: 'isitopen'
	},
	{
		name: "ISEC '26 Workshop Website",
		codeUrl: 'https://github.com/genai4se/ISEC26-Workshop',
		deployedUrl: 'https://genai4se.github.io/ISEC26-Workshop/',
		coverImage: '/projects/isec26/isec26-1.png',
		screenshots: [
			'/projects/isec26/isec26-3.png',
			'/projects/isec26/isec26-4.png',
	...
	{
		name: 'MyIIIT App',
		coverImage: '/projects/myiiit/myiiit-1.png',
		screenshots: [
			'/projects/myiiit/myiiit-2.png',
			'/projects/myiiit/myiiit-3.png',
			'/projects/myiiit/myiiit-4.png',
			'/projects/myiiit/myiiit-5.png'
		],
		deployedUrl: 'https://ims-app.iiit.ac.in/',
		description:
			'MyIIIT is a mobile application that was built completely by students in 2023 as a project in the Design and Analysis of Softare Systems Course. It was built using React Native and deployed on the Google Play Store and Apple App Store. The backend uses FastAPI. I and a couple of my friends were asked to continue work on it by our seniors, and help maintain it. We started with redesigning the UI to look more polished and modern. Now, we are adding more features as requirements arise. I also helped in conducting interviews and recruiting new members to the team. One of the biggest contributions I made is adding Firebase notifications for background updates. This was also my first time working with Firebase.',
		shortDescription: 'The official mobile app of IIITH.',
		year: 2025,
		technologies: ['React Native', 'FastAPI', 'Firebase'],
		slug: 'myiiit'
	},
	{
		name: 'SustAInd Website',
		deployedUrl: 'https://sa4s-serc.github.io/sustaind/',
		coverImage: '/projects/sustaind/sustaind-1.png',
		screenshots: [
			'/projects/sustaind/sustaind-2.png',
			'/projects/sustaind/sustaind-3.png',
			'/projects/sustaind/sustaind-4.png'
		],
		description:
			'I was asked to build this website for SustAInd, a research project borne out of the ANRF grant by my advisor. It was built using Next.js and deployed as a static site on GitHub Pages. I learnt a lot about how to build Next.js components for static sites, mostly through trial and error due to the lack of good documentation.',
		shortDescription: 'The official website of SustAInd, a research project at SERC, IIITH.',
		year: 2025,
		technologies: ['Next.js', 'GitHub Pages'],
		slug: 'sustaind'
	},
	{
		...
		coverImage: '/projects/cos/cos-1.png',
		screenshots: [
			'/projects/cos/cos-2.png',
			'/projects/cos/cos-3.png',
			'/projects/cos/cos-4.png',
			'/projects/cos/cos-5.png'
		],
		description:
			'A web application for ordering food from any canteen at IIIT Hyderabad. It was made in collaboration with Sanyam Gandhi, then the elected head of Stall Committee. He asked me to collaborate on this after seeing my work on the Food@IIIT app.',
		shortDescription: 'A web application for ordering food from any canteen at IIIT Hyderabad',
		year: 2025,
	...
	{
		name: 'Dentimplant',
		deployedUrl: 'https://dentimplant.co.in',
		coverImage: '/projects/dentimplant/dentimplant-1.png',
		screenshots: [
			'/projects/dentimplant/dentimplant-2.png',
			'/projects/dentimplant/dentimplant-3.png',
			'/projects/dentimplant/dentimplant-4.png'
		],
		description:
			'Dentimplant is an additional service provided by the Affordable Implant Dentistry (AID) initiative started by my father. It allows dentists to completely manage their implant practice online, from keeping track of all their patients and their treatments, to keeping a record of their inventory and finances.',
		shortDescription: 'Implant practice management platform for dentists',
		year: 2025,
	...
	},
	{
		...
		screenshots: [
			'/projects/yada/yada2.png',
			'/projects/yada/yada3.png',
			'/projects/yada/yada4.png',
			'/projects/yada/yada5.png',
			'/projects/yada/yada6.png',
			'/projects/yada/yada7.png'
		],
		description:
	...
	},
	{
		...
		description:
			'Built for the Wikimedia Hackathon 2024, this dashboard helps Wikimedia community members monitor unusual website traffic and take action, such as organizing events or analyzing impact. I developed the website while my collaborator, Navya Sri Kalli, handled the Python data analysis.',
	...
	},
	{
		...
		description:
			'A custom shell implemented in low-level C, supporting pipes, redirection, and common shell operations. This was an individual assignment for the Operating Systems and Networks Monsoon 2024 course, and I took 60 hours to complete it.',
	...
	},
	{
		...
		description:
			'This was a course project for the course Introduction to Software Systems in Spring 2024. It takes in images in any format, and outputs a video in a variety of formats and resolutions. One can add sounds from the library, or upload their own, and also diverse transitions between images. It uses FFMPEG under the hood to process videos in parallel, but the real selling point of this application is its UI and UX. This was made in collaboration with Team Code Fusion, consisting of Aviral Gupta and Mohit Kumar Singh. A hilarious bug caused all images to be widened, and we left it in because it made every video 10x better.',
	...
	},
	{
		...
		description:
			'My friend Ira is a prolific writer, so I thought to present her with a blog that she can use to showcase her writing to the world. It is made such that articles can be written in simple Markdown, and later are converted to HTML pages for the static site. At her request, every article includes a related song meant to be listened to while reading the contents.',
